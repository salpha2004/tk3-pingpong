    ...
    public void draw (Graphics g) {
        ...
        switch (_numPlayers) {
            case 4:
                ...
                g.fillRect (_rightBatX, _rightBatY, _batHeight, _batLength);
            case 3:
                g.setColor (new Color(0, 200, 0));
                g.fillRect (_leftBatX, _leftBatY, _batHeight, _batLength);
            case 2:
                g.setColor (new Color(200, 0, 0));
                g.fillRect (_topBatX, _topBatY,  _batLength, _batHeight);
            case 1:
